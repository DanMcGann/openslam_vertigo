...
struct SwitchVariableSigmoid : public DerivedValue<SwitchVariableSigmoid> {
  ...
  /** identity */
  inline static SwitchVariableSigmoid identity() { return SwitchVariableSigmoid(); }
  ...
  /** between operation */
  inline SwitchVariableSigmoid between(const SwitchVariableSigmoid& l2, boost::optional<Matrix&> H1 = boost::none,
  ...
  inline SwitchVariableSigmoid inverse() const { return SwitchVariableSigmoid(-1.0 * value()); }
